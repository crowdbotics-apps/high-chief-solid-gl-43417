...
## Project Structure
    ...
    ├── high_chief_solid_gl_43417  # Django project configurations
...
1. Clone this repo and `cd high_chief_solid_gl_43417`
...
2. Clone this repo and `cd high_chief_solid_gl_43417`
