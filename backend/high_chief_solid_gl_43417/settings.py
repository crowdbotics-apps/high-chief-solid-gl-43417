"""
Django settings for high_chief_solid_gl_43417 project.
...
ROOT_URLCONF = 'high_chief_solid_gl_43417.urls'
...
WSGI_APPLICATION = 'high_chief_solid_gl_43417.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "high_chief_solid_gl_43417 API",
    "DESCRIPTION": "API documentation for high_chief_solid_gl_43417 App",
    "VERSION": "v1",
}
